        ...
        if (bmpValid && mCacheBitmap != null) {
            ...
            if (canvas != null) {
                ...
                if(orientation == Configuration.ORIENTATION_LANDSCAPE){
	                ...
	                //Log.d(TAG, "Canvassize="+height_Canvas+"x"+width_Canvas);
	                //Log.d(TAG, "Bitmapsize="+height+"x"+width);
	                
	                //float f1 = (width_Canvas - width) / 2;
	                //float f2 = (height_Canvas - height) / 2;
	                //matrix.preTranslate(f1, f2);
	                //matrix.postRotate(90f,(height_Canvas) / 2,(width_Canvas) / 2);
	                //matrix.postScale(1.0f*width_Canvas/height, 1.0f*width_Canvas/height);
                	
	                matrix.preScale(1.0f*width_Canvas/height, 1.0f*width_Canvas/height);
	                matrix.postRotate(90f);
	                matrix.postTranslate(width_Canvas, (height_Canvas-1.0f*width_Canvas/height*width)/2);
